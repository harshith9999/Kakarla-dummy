...
export default function Header({ role }) {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      <CssBaseline />
      <AppBar position="fixed" sx={bgcolor} open={open}>
        <Toolbar>
          <IconButton
            color="inherit"
          ...
          <Link href='/home' underline="none" sx={color}>
      ...
      >
        ...
        <List>
          <ListItem button onClick={() => navigate('/')} key='Home'
           sx={{'&:hover': { backgroundColor: '#fcbd2e', color: 'white' },
            ...
            backgroundColor:window.location.pathname === '/home' && '#fcbd2e'}}>
        ...
        <List>
          ...
          <ListItem button onClick={logoutHandler} key='Logout'
           ...
           backgroundColor:window.location.pathname === '/login' && '#fcbd2e'}}>
            <ListItemIcon>
              <InboxIcon />
            </ListItemIcon>
